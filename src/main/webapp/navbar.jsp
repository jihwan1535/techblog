...
<nav class="navbar navbar-expand-lg navbar-light mb-4"
     style="background-color: #ffffff; border-bottom: 1px solid #ced4da; padding-left: 190px">
    ...
    <div class="collapse navbar-collapse ms-auto" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mx-3">
            ...
            %>
            <li class="nav-item">
                <a class="btn btn-outline-dark nav-btn rounded-pill" style="margin-top: 4px; margin-right: 5px;"
                   href="/api/posting">포스팅</a>
            </li>
