  ...
  <div class="collapse navbar-collapse ms-auto" id="navbarSupportedContent">
    <ul class="navbar-nav ms-auto mx-3">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle no-caret" href="#" id="Notification" role="button" data-bs-toggle="dropdown" aria-expanded="false" style=" margin-top: 2px; margin-right: 5px;">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle no-caret" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
